...
void Scene::load( void ) 
{
    ...
    // Spheres
    primitives_.push_back( Primitive::PrimitiveUniquePtr( new Sphere{ glm::vec3{ -0.5f, -0.65f, -1.5f }, 0.4f, glm::vec3 { 0.725f, 0.71f, 0.68f }, glm::vec3 { .0f }, "diffuse" } ) );
    primitives_.push_back( Primitive::PrimitiveUniquePtr( new Sphere{ glm::vec3{ 0.6f, -0.65f, -1.8f }, 0.4f, glm::vec3 { 0.725f, 0.71f, 0.68f }, glm::vec3 { .0f }, "mirror" } ) );

    // Back
    primitives_.push_back( Primitive::PrimitiveUniquePtr( new Triangle{ glm::vec3 { 1.2f, -1.2f, -2.5f },
                                            glm::vec3 { -1.2f, 1.2f, -2.5f }, glm::vec3 { -1.2f, -1.2f, -2.5f }, glm::vec3 { 0.725f, 0.71f, 0.68f }, glm::vec3 { .0f }, "diffuse" } ) );
    primitives_.push_back( Primitive::PrimitiveUniquePtr( new Triangle{ glm::vec3 { 1.2f, -1.2f, -2.5f },
                                            glm::vec3 { 1.2f, 1.2f, -2.5f }, glm::vec3 { -1.2f, 1.2f, -2.5f }, glm::vec3 { 0.725f, 0.71f, 0.68f }, glm::vec3 { .0f }, "diffuse" } ) );

    // Floor
    primitives_.push_back( Primitive::PrimitiveUniquePtr( new Triangle{ glm::vec3 { -1.2f, -1.2f, -2.5f },
                                            glm::vec3 { 1.2f, -1.2f, -2.5f }, glm::vec3 { -1.2f, -1.0f, -1.0f }, glm::vec3 { 0.725f, 0.71f, 0.68f }, glm::vec3 { .0f }, "diffuse" } ) );
    primitives_.push_back( Primitive::PrimitiveUniquePtr( new Triangle{ glm::vec3 { -1.2f, -1.0f, -1.0f },
                                            glm::vec3 { 1.2f, -1.2f, -2.5f }, glm::vec3 { 1.2f, -1.0f, -1.0f }, glm::vec3 { 0.725f, 0.71f, 0.68f }, glm::vec3 { .0f }, "diffuse" } ) );    

    // Left Wall
    primitives_.push_back( Primitive::PrimitiveUniquePtr( new Triangle{ glm::vec3 { -1.2f, -1.2f, -2.5f },
                                            glm::vec3 { -1.2f, -1.0f, -1.0f }, glm::vec3 { -1.2f, 1.2f, -2.5f }, glm::vec3 { 0.14f, 0.45f, 0.091f }, glm::vec3 { .0f }, "diffuse" } ) );
    primitives_.push_back( Primitive::PrimitiveUniquePtr( new Triangle{ glm::vec3 { -1.2f, 1.2f, -2.5f },
                                            glm::vec3 { -1.2f, -1.0f, -1.0f }, glm::vec3 { -1.2f, 1.2f, -1.0f }, glm::vec3 { 0.14f, 0.45f, 0.091f }, glm::vec3 { .0f }, "diffuse" } ) );    

    // Right Wall
    primitives_.push_back( Primitive::PrimitiveUniquePtr( new Triangle{ glm::vec3 { 1.2f, 1.2f, -1.0f },
                                            glm::vec3 { 1.2f, -1.0f, -1.0f }, glm::vec3 { 1.2f, 1.2f, -2.5f }, glm::vec3 { 0.63f, 0.065f, 0.05f }, glm::vec3 { .0f }, "diffuse" } ) );
    primitives_.push_back( Primitive::PrimitiveUniquePtr( new Triangle{ glm::vec3 { 1.2f, 1.2f, -2.5f },
                                            glm::vec3 { 1.2f, -1.0f, -1.0f }, glm::vec3 { 1.2f, -1.2f, -2.5f }, glm::vec3 { 0.63f, 0.065f, 0.05f }, glm::vec3 { .0f }, "diffuse" } ) );    
    ...
    primitives_.push_back( Primitive::PrimitiveUniquePtr( new Triangle{ glm::vec3 { -1.2f, 1.2f, -1.0f },
                                            glm::vec3 { -1.2f, 1.2f, -2.5f }, glm::vec3 { 1.2f, 1.2f, -2.5f }, glm::vec3 { 0.725f, 0.71f, 0.68f }, glm::vec3 { .0f }, "diffuse" } ) );
    primitives_.push_back( Primitive::PrimitiveUniquePtr( new Triangle{ glm::vec3 { 1.2f, 1.2f, -2.5f },
                                            glm::vec3 { 1.2f, 1.2f, -1.0f }, glm::vec3 { -1.2f, 1.2f, -1.0f }, glm::vec3 { 0.725f, 0.71f, 0.68f }, glm::vec3 { .0f }, "diffuse" } ) );    

    // Light Source
    primitives_.push_back( Primitive::PrimitiveUniquePtr( new Triangle{ glm::vec3 { -0.5f, 1.19f, -1.5f },
                                            glm::vec3 { -0.5f, 1.19f, -2.0f }, glm::vec3 { 0.5f, 1.19f, -2.0f }, glm::vec3 { .0f }, glm::vec3 { 30.0f }, "diffuse" } ) );
    primitives_.push_back( Primitive::PrimitiveUniquePtr( new Triangle{ glm::vec3 { 0.5f, 1.19f, -2.0f },
                                            glm::vec3 { 0.5f, 1.19f, -1.5f }, glm::vec3 { -0.5f, 1.19f, -1.5f }, glm::vec3 { .0f }, glm::vec3 { 30.0f }, "diffuse" } ) );
}

void Scene::load(const std::string& filename, glm::vec3 brdf, glm::vec3 emmitance, std::string material) {
    ...
    if (assimp_scene_->HasMeshes()) {
        ...
        for (unsigned int mesh_id = 0; mesh_id < assimp_scene_->mNumMeshes; mesh_id++) {
            ...
            for (unsigned int vertex_id = 0; vertex_id < mesh_ptr->mNumVertices; vertex_id += 3) {
                ...
                primitives_.push_back(std::make_unique<Triangle>(v0, v1, v2, brdf, emmitance, material));
            }
        }
    }
}
